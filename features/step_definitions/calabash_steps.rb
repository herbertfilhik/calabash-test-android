...
And /^I click on Agendamento de Preço Option fill fields$/ do
    ...
    sleep 1
   	enter_text("android.support.v7.widget.AppCompatEditText id:'etName'", "AgendamentoPrecoMobile")
   	sleep 1
	...
	tap_when_element_exists("android.support.v7.widget.AppCompatButton id:'button1'")	
	sleep 1
	tap_when_element_exists("android.support.v7.view.menu.ActionMenuItemView id:'imNext'")
	sleep 1
	...
	enter_text("android.support.v7.widget.AppCompatEditText id:'etPercentual'")
	tap_when_element_exists("android.support.v7.view.menu.ActionMenuItemView id:'imNext'")
end
